  ...
  return (
    <div>
      <div
       ...
       text-center justify-between lg:text-sm text-xs p-2 lg:p-1"
      >
        ...
        <div className="flex items-center gap-2">
          <MdOutlineSmartphone className="text-lg" />
      ...
      <div className="flex md:justify-around justify-between relative md:py-2 px-4 md:px-0">
        ...
        {active && (
          <div
            className={`fixed top-[34px] lg:hidden left-0 h-[calc(100%-48px)] bg-white w-[60%] z-40 transform ${
              active ? "translate-x-0" : "-translate-x-full"
            } transition-transform duration-1000 ease-in-out shadow-md`}
          >
            <div className="flex justify-between items-center px-4 ">
              ...
              <MdClose
                ...
                className="text-2xl cursor-pointer hover:text-[#00A183]"
              />
            </div>
