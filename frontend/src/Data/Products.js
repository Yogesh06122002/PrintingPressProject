export const Products = [
  {
    ...
    items: [
      ...
      {
        name: "Viscose Printed Label and Tapes",
        images: ["/images/PrintedLabelsImg/viscose Printed Labels.jpg"],
        id: 13,
      ...
      },
      {
        ...
        images: ["/images/PrintedLabelsImg/polyCottonLabel.jpg"],
        id: 15,
        alt: "Poly-Cotton Printed Label",
        disc: "We are providing an extensive range of Poly-Cotton printed labels and tapes with good quality standard and we offer Labels in various Printing colors, shapes, sizes and designs as per the specifications of clients. The complete range of Labels is properly manufactured as per their needs and requirements under the strict direction of our team. Our labels are offered to the customers at cost effective rates.",
      },
      {
        name: "Satin Printed Label",
        images: ["/images/PrintedLabelsImg/satin-printed-label.jpg"],
        id: 16,
        alt: "Satin Printed Label",
        disc: "We are the reliable organization, ranking among the utmost entities in providing a wide assortment of Printed Satin Labels. Ideal for fine, small or very detailed artwork, we are giving these satin labels in numerous specifications as well as, offer custom-made facility in order to fulfill various needs of customers. The complete range of satin labels is properly manufactured according to the customer’s requirements under the strict direction of accomplished personnel by using material & latest technology. . Our labels are offered to the customers at cost effective rates.",
      },
      {
        name: "Tafetta Printed Label",
        images: ["/images/PrintedLabelsImg/taffeta-printed-labels.jpg"],
        id: 17,
        alt: "Tafetta Printed Label",
        disc: "Our Taffeta Printed Label are made-up by the use of optimum quality material. All labels are easy to read by the buyers. These labels are made-up at our well-sophisticated units under the strict guidance of professionals. These printed labels are widely appreciated by all customers for their longer functional life. We offer all our labels at market’s most nominal prices.",
      },
      {
        name: "Polyester Printed Label",
        images: ["/images/PrintedLabelsImg/Polyester Printed Label.jpg"],
        id: 2,
        alt: "Polyester Printed Label",
